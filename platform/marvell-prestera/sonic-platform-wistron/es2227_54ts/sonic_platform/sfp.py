...
class Sfp(SfpOptoeBase):
    ...
    # Absolute numbers used to be base+offset with base=472; on kernel 6.12
    # the gpiochip base is dynamic — resolve at runtime.
    ...
    def _gpio_base(cls):
        ...
        # The driver may not be ready yet. Cache only successful lookups so
